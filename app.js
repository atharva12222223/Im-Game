...
// ==========================================
// SMART SINGLE-WORD HINT DICTIONARY
// ==========================================
const WORD_HINTS = {
  // Food & Drinks
  'Pizza': 'Cheese',
  ...
  'Threesome': 'Trio',
  'Body Count': 'History',
  'Netflix and Chill': 'Couch',
  'Sugar Mommy': 'Spoiling',
  'Freaky Friday': 'Wild',
  'Sexting': 'Messages',
  'Drunk Texting': 'Regret',
  'Side Piece': 'Affair',
  'Lap Dance': 'Club',
  'Mile High Club': 'Airplane',
  'Fake Moaning': 'Pretending',
  'Friendzone': 'Platonic',
  'Caught in 4K': 'Exposed',
  'Stripper Pole': 'Stage',
  'Late Night Uber': 'Rideshare',
  'Skinny Dipping': 'Nude',
  'Body Shots': 'Tequila',
  'Tinder Hookup': 'Swipe',
  'Glory Hole': 'Partition',
  'Spanking': 'Discipline',
  ...
  'Stalker Ex': 'Lurking',
  'Late Night Facetime': 'Midnight',
  'Ghosting': 'Disappearing',
  'Cuddle Buddy': 'Snuggle',
  'Whipped Cream': 'Topping',
  'Hot Tub Party': 'Jacuzzi',
  'Booty Call': 'Summons',
...
function updateGameScreen() {
  ...
  if (isImposter) {
    ...
    const singleClue = getWordClue(game.currentWord);
    ...
    cardBack.innerHTML = `
      ...
      <div class="imposter-clue-card">
        <span class="clue-badge">💡 RELATED WORD</span>
        <span class="imposter-one-word">"${singleClue}"</span>
      </div>

      <span class="card-role-hint">Blend in & figure out the secret word!</span>
    `;
  } else {
